...
=============================================================================
Users can remove all edges which can not be used by passenger vehicles. Here, if your road network is with  left-hand drive, please use **"--lefthand"** option for every time that you convert the network. **To disable u-turn or loop, please use "--no-turnarounds" option**.
